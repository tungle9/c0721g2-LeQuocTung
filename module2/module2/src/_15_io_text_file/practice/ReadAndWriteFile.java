...
//            }
    ...
    public static void main(String[] args) {
        ...
        List<Integer> numbers = readAndWriteFile.readFile("src\\_15_io_text_file\\practice\\file.text");
        int max = findMax(numbers);
        readAndWriteFile.writeFile("src\\_15_io_text_file\\practice\\file.text", max);
    }
}