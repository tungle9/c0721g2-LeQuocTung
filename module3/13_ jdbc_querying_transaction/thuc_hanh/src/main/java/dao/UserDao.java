...
public class UserDao implements IUserDao {
    ...
    public void insertUpdateUseTransaction() {
        try (Connection connection = getConnection();
             ...
             PreparedStatement psInsert = connection.prepareStatement(INSERT_USERS_SQL);
             PreparedStatement psUpdate = connection.prepareStatement(UPDATE_USERS_SQL)) {
            statement.execute("delete table users");
